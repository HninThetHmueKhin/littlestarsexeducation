...
namespace ChildSafeSexEducation.Desktop
{
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            // Set English as default language and update UI
            _languageService.SetLanguage(Services.Language.English);
            UpdateAllUIElementsToEnglish();
        ...
        private void UpdateLoginLabels()
        {
            if (_languageService.CurrentLanguage == Services.Language.English)
            {
                ...
                SwitchToRegisterButton.Content = "Create Account";
                SwitchToLoginButton.Content = "Already have an account?";
            }
            else
            {
                ...
                SwitchToRegisterButton.Content = "အကောင့်ဖွင့်ရန်";
                SwitchToLoginButton.Content = "အကောင့်ရှိပြီးသားလား?";
            }
        }
        ...
        private void LoginButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (_userStorageService.ValidateUser(username, password))
            {
                ...
                if (_currentUser != null)
                {
                    ...
                    if (_currentUser.PreferredLanguage == "Burmese")
                    {
                    ...
                    // Update all UI labels after language change
                    UpdateAllLabels();
        ...
        {
            if (ChatPanel == null || ChatScrollViewer == null)
            {
                return null;
            }
        ...
        {
            Console.WriteLine("🔤 ENGLISH BUTTON CLICKED - UPDATING TO ENGLISH");
            
            // Visual feedback - highlight the clicked button
            if (EnglishButton != null)
            {
                EnglishButton.Background = new System.Windows.Media.SolidColorBrush(System.Windows.Media.Colors.LightGreen);
            ...
            // Clear chat and add English welcome message
            if (ChatPanel != null)
            {
                ChatPanel.Children.Clear();
                AddMessageToChat("Hello! I'm here to help you learn about safe and healthy topics. You can ask me questions or click the Topics button to see what we can learn about together!", false);
            ...
            Console.WriteLine("✅ ENGLISH LANGUAGE UPDATED SUCCESSFULLY");
        }
        ...
        {
            Console.WriteLine("🔤 BURMESE BUTTON CLICKED - UPDATING TO BURMESE");
            
            // Visual feedback - highlight the clicked button
            if (BurmeseButton != null)
            {
                BurmeseButton.Background = new System.Windows.Media.SolidColorBrush(System.Windows.Media.Colors.LightGreen);
            ...
            // Update all UI elements to Burmese
            UpdateAllUIElementsToBurmese();
            ...
            // Clear chat and add Burmese welcome message
            if (ChatPanel != null)
            {
                ChatPanel.Children.Clear();
                AddMessageToChat("မင်္ဂလာပါ! ကျွန်တော်က လုံခြုံပြီး ကျန်းမာသော အကြောင်းအရာများအကြောင်း သင်ယူရန် ကူညီပေးရန် ဤနေရာတွင် ရှိပါတယ်။ သင်မေးခွန်းများ မေးနိုင်ပြီး သို့မဟုတ် ခေါင်းစဉ်များ ခလုတ်ကို နှိပ်ပြီး ကျွန်တော်တို့ အတူတကွ သင်ယူနိုင်သော အရာများကို ကြည့်နိုင်ပါတယ်!", false);
            ...
            Console.WriteLine("✅ BURMESE LANGUAGE UPDATED SUCCESSFULLY");
        }
