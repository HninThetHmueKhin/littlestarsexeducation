        ...
        private List<Topic> InitializeTopics()
        {
            return new List<Topic>
            {
                ...
                new Topic
                {
                    ...
                    Questions = new List<Question>
                    {
                        new Question { Id = 7, QuestionText = "question_what_changes", Answer = "answer_what_changes", TopicId = 3, MinAge = 10, MaxAge = 15 },
                        new Question { Id = 8, QuestionText = "question_when_puberty", Answer = "answer_when_puberty", TopicId = 3, MinAge = 10, MaxAge = 15 },
                        new Question { Id = 9, QuestionText = "question_why_hair_grow", Answer = "answer_why_hair_grow", TopicId = 3, MinAge = 10, MaxAge = 15 }
                    }
                },
                new Topic
                {
                    ...
                    Questions = new List<Question>
                    {
                        new Question { Id = 10, QuestionText = "question_what_good_friend", Answer = "answer_good_friend", TopicId = 4, MinAge = 8, MaxAge = 15 },
                        new Question { Id = 11, QuestionText = "question_how_handle_bullying", Answer = "answer_handle_bullying", TopicId = 4, MinAge = 8, MaxAge = 12 },
                        new Question { Id = 12, QuestionText = "question_what_peer_pressure", Answer = "answer_peer_pressure", TopicId = 4, MinAge = 8, MaxAge = 15 }
                    }
                }
            };
        }
